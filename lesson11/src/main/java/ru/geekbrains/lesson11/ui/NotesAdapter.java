 ...
 */
public class NotesAdapter extends RecyclerView.Adapter<ru.geekbrains.lesson11.ui.NotesAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ru.geekbrains.lesson11.ui.NotesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ru.geekbrains.lesson11.ui.NotesAdapter.ViewHolder holder, int position) {
