package ru.geekbrains.lesson9.ui;
...
import ru.geekbrains.lesson9.Note;
import ru.geekbrains.lesson9.R;

/**
 * @author Zurbaevi Nika
 */
public class NotesAdapter extends RecyclerView.Adapter<ru.geekbrains.lesson9.ui.NotesAdapter.ViewHolder> {
    private Note[] notes;
    ...
    @NonNull
    @Override
    public ru.geekbrains.lesson9.ui.NotesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ru.geekbrains.lesson9.ui.NotesAdapter.ViewHolder holder, int position) {
